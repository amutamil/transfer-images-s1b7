...
typedef struct ValErr_struct
{
    ...
    int             ParentMsgID;    /* Parent ID of message or item object containing the tag */
    int             MsgLevel;       /* Level of message or item object containing the tag */
} VAL_ERR;
...
typedef enum XmlOptions
{
    ...
    XmlOptIndentation              = 0x20
} XML_OPTIONS;

/* ======================================================================== *
 *                    JSON Conversion Configuration Options                  *
 * ======================================================================== */
typedef enum JsonOptions
{
    JsonOptDefault                  = 0x0,
    JsonOptIncludeBulks             = 0x1,
    JsonOptIncludePixelData         = 0x2,
    JsonOptExcludeSequences         = 0x4,
    JsonOptExcludePrivateAttributes = 0x8,
    JsonOptIndentation              = 0x10
} JSON_OPTIONS;
...
typedef enum {
    ...
    ALLOW_INVALID_VALUE_FOR_VR,             /* non-documented, internal use only */
    CAPTURE_FILE,
    COMPRESSION_LIBRARY_TO_USE,
...
#define Bitbucket_Destination (1 << 3)
...
typedef enum {
    ...
    ALLOW_MULTIPLE_VALUES_FOR_STRING_NUMBER, /* non-documented, internal use only */
    ...
    REJECT_INVALID_VR,
    REJECT_REASON_DICOM_STANDARD_ONLY,
    RELEASE_SQ_ITEMS,
    ...
    TREAT_VR_OF_NOT_IN_DICTIONARY_TAG_AS_UN,
...
EXP_PRE extern MC_STATUS    EXP_FUNC MC_Set_MergeINI_Unicode(void *Afilename);
EXP_PRE extern MC_STATUS    EXP_FUNC MC_Get_Version_String(int AbufferSize, char* Abuffer);

/* ======================================================================== *
 *               Functions to set the library exceptions handler            *
 * ======================================================================== */

typedef void(*MCLibraryExceptionHandler)(int);
EXP_PRE extern MC_STATUS    EXP_FUNC MC_Set_Library_Exception_Handler( MCLibraryExceptionHandler handler );
EXP_PRE extern MC_STATUS    EXP_FUNC MC_Release_Library_Exception_Handler(void);
...
EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_Value_From_Buffer(int AmsgID, unsigned long  Atag, void* Avalue, unsigned long  AvalueLength);
...
EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_Encapsulated_Value_From_Function(int            AmsgID,
                                                                          unsigned long  Atag,
                                                                          void*          AuserInfo,
                                                                          MC_STATUS      (NOEXP_FUNC *AuserFunction)
                                                                         (int            CBmsgID,
...
EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_Next_Encapsulated_Value_From_Function(int            AmsgID,
                                                                               unsigned long  Atag,
                                                                               void*          AuserInfo,
                                                                               MC_STATUS      (NOEXP_FUNC *AuserFunction)
                                                                              (int            CBmsgID,
...
EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_pValue_From_Float(int AmsgID, const char* AprivateCode, unsigned short Agroup, unsigned char Aelem, float Avalue);

EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_pValue_From_Int(int AmsgID, const char* AprivateCode, unsigned short Agroup, unsigned char Aelem, int Avalue);

EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_pValue_From_ShortInt(int AmsgID, const char* AprivateCode, unsigned short Agroup, unsigned char Aelem, short Avalue);

EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_pValue_From_LongInt(int AmsgID, const char* AprivateCode, unsigned short Agroup, unsigned char Aelem, long Avalue);

EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_pValue_From_String(int AmsgID, const char* AprivateCode, unsigned short Agroup, unsigned char Aelem, const char* Avalue);

EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_pValue_From_UInt(int AmsgID, const char* AprivateCode, unsigned short Agroup, unsigned char Aelem, unsigned int Avalue);

EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_pValue_From_UShortInt(int AmsgID, const char* AprivateCode, unsigned short Agroup, unsigned char Aelem, unsigned short Avalue);

EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_pValue_From_ULongInt(int AmsgID, const char* AprivateCode, unsigned short Agroup, unsigned char Aelem, unsigned long Avalue);

EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_pValue_From_Buffer(int AmsgID, const char* AprivateCode, unsigned short Agroup, unsigned char Aelem, void* Avalue, unsigned long AvalueLength);

EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_pValue_From_Function(int            AmsgID,
                                                              const char*    AprivateCode,
                                                              unsigned short Agroup,
                                                              unsigned char  Aelem,
                                                              void*          AuserInfo,
...
EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_Next_pValue_To_NULL(int AmsgID, const char* AprivateCode, unsigned short Agroup, unsigned char Aelem);

EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_Next_pValue(int AmsgID, const char* AprivateCode, unsigned short Agroup, unsigned char Aelem, MC_DT AdataType, void* Avalue);

EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_Next_pValue_From_Double(int AmsgID, const char* AprivateCode, unsigned short Agroup, unsigned char Aelem, double Avalue);

EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_Next_pValue_From_Float(int AmsgID, const char* AprivateCode, unsigned short Agroup, unsigned char Aelem, float Avalue);

EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_Next_pValue_From_Int(int AmsgID, const char* AprivateCode, unsigned short Agroup, unsigned char Aelem, int Avalue);

EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_Next_pValue_From_ShortInt(int AmsgID, const char* AprivateCode, unsigned short Agroup, unsigned char Aelem, short Avalue);

EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_Next_pValue_From_LongInt(int AmsgID, const char* AprivateCode, unsigned short Agroup, unsigned char Aelem, long Avalue);

EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_Next_pValue_From_String (int AmsgID, const char* AprivateCode, unsigned short Agroup, unsigned char Aelem, const char* Avalue);

EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_Next_pValue_From_UInt(int AmsgID, const char* AprivateCode, unsigned short Agroup, unsigned char Aelem, unsigned int Avalue);

EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_Next_pValue_From_UShortInt(int AmsgID, const char* AprivateCode, unsigned short Agroup, unsigned char Aelem, unsigned short Avalue);

EXP_PRE extern MC_STATUS EXP_FUNC MC_Set_Next_pValue_From_ULongInt(int AmsgID, const char* AprivateCode, unsigned short Agroup, unsigned char Aelem, unsigned long Avalue);
...
EXP_PRE extern MC_STATUS EXP_FUNC MC_Get_MergeCOM_Service_From_UID(const char *Auid, char *AserviceName, int AbufferSize);
...
/* ===================================================================================== *
 *     Functions to convert the contents of a message to/from DICOM Native XML format    *
 * ===================================================================================== */
EXP_PRE extern MC_STATUS EXP_FUNC MC_Message_To_XML_Native(int          AmsgID,
                                                           void*        AuserInfo,
                                                           XML_OPTIONS  AxmlOptions,
                                                           MC_STATUS    (NOEXP_FUNC *AuserFunction)
                                                                        (int      CBmessageID,
...
EXP_PRE extern MC_STATUS EXP_FUNC MC_XML_Native_To_Message(int          AmsgID,
                                                           void*        AuserInfo,
                                                           MC_STATUS    (NOEXP_FUNC *AuserFunction)
                                                                        (int        CBmessageID,
                                                                        void*      CBuserInfo,
...
/* ===================================================================================== *
 *     Functions to convert the contents of a message to/from DICOM JSON format          *
 * ===================================================================================== */
EXP_PRE extern MC_STATUS EXP_FUNC MC_Message_To_Json(int           AmsgID,
                                                     void*         AuserInfo,
                                                     JSON_OPTIONS  AjsonOptions,
                                                     MC_STATUS     (NOEXP_FUNC *AuserFunction)
                                                                   (int      CBmessageID,
                                                                    void*    CBuserInfo,
                                                                    int      CBdataSize,
...
EXP_PRE extern MC_STATUS EXP_FUNC MC_Json_To_Message(int        AmsgID,
                                                     void*      AuserInfo,
                                                     MC_STATUS  (NOEXP_FUNC *AuserFunction)
                                                                (int        CBmessageID,
                                                                 void*      CBuserInfo,
...
EXP_PRE extern MC_STATUS EXP_FUNC MC_Unicode_Get_Substitution_Characters(char *Acharset, char *Aval, int *Alen);
